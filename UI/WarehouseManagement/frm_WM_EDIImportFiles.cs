...
{
    public partial class frm_WM_EDIImportFiles : Common.Controls.frmBaseForm
    {
        ...
        public frm_WM_EDIImportFiles(int customerID)
        {
            InitializeComponent();
            this.customerIDSelected = customerID;
            SetEvent();
        }
        void Frm_WM_EDIImportFiles_Load(object sender, EventArgs e)
        {
        ...
        void SetEvent()
        {
            this.Load += Frm_WM_EDIImportFiles_Load;
            ...
            btn_CreateEDI.Click += Btn_CreateEDI_Click;
        ...
        void Btn_ImportFile_Click(object sender, EventArgs e)
        {
            ...
            if (m_TypeCustomerEDI.Equals(eTypeCustomerEDI.eCustomerCommon))
            {
                if (ImportDataFromExcelCustomerCommon(v_PathFile))
                {
                    ...
                    this.btn_CreateEDI.Enabled = true;
                }
                else
                {
        ...
        void Btn_CreateEDI_Click(object sender, EventArgs e)
        {
            int v_CustomerID = 0;
            ...
            if (m_TypeCustomerEDI.Equals(eTypeCustomerEDI.eCustomerCommon))
            {
                try
                {
                    ...
                    foreach (var v_Item in v_ListPicKing)
                    {
                        ...
                        v_ObjEDIOrder.OrderType = Convert.ToInt32(this.radioGroup_OrderType.EditValue);
                        ...
                        //int v_RetInsertPic = v_DaInsertPic.ExecSQLString(v_StrSQL);

                        DataProcess<object> dataProcess = new DataProcess<object>();
                        int result = dataProcess.ExecuteNoQuery(v_StrSQL);


                        //int v_RetInsertPic1 = v_DaInsertPic.ExecSQLString("STCreateEDIFromPickingList @EDI_OrderID =" + v_ObjEDIOrder.EDI_OrderID
                        //    + ",@varProcessOrderNum =N'" + v_varProcessOrderNum + "',@TruckNo =N'" + v_Item.Truck_no + "',@User='" + m_userName + "'");
                    ...
                    //
                    this.txtEdit_Message.ForeColor = System.Drawing.Color.Blue;
                    this.txtEdit_Message.Text = "Create EDI succesful !";
                    if (MessageBox.Show("Create EDI succesful !", "", MessageBoxButtons.OK) == DialogResult.OK)
                    {
                        this.Close();
                    }
                    ...
                    this.btn_CreateEDI.Enabled = false;

                }
                catch (Exception ex)
                {
                    txtEdit_Message.ForeColor = System.Drawing.Color.Red;
                    this.txtEdit_Message.Text = "Error Create EDI !";
                }
            }
