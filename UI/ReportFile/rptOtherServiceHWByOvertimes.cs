...
{
    public partial class rptOtherServiceHWByOvertimes : DevExpress.XtraReports.UI.XtraReport
    {
        
        public rptOtherServiceHWByOvertimes(int flag)
        {
            InitializeComponent();
            if (flag == 0)
            {
                this.xrLabel1.Text = "HANDLING SERVICE DETAILS REPORT";
            }
