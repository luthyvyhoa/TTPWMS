...
{
    public partial class rptStockDispatched : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockDispatched(string customerNumber, string customerName, DateTime fromDate, DateTime toDate)
        {
            InitializeComponent();
