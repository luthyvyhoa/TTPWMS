...
{
    public partial class rptStockDispatchedDetailsKGR : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockDispatchedDetailsKGR(string customerNumber, string customerName, DateTime fromDate, DateTime toDate)
        {
            InitializeComponent();
