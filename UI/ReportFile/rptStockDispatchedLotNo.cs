...
{
    public partial class rptStockDispatchedLotNo : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockDispatchedLotNo(string customerNumber, string customerName, DateTime fromDate, DateTime toDate)
        {
            InitializeComponent();
