...
{
    public partial class rptStockMovementKGRLotNo : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockMovementKGRLotNo()
        {
            InitializeComponent();
        ...
        private void rptStockMovementKGRLotNo_DataSourceDemanded(object sender, EventArgs e)
        {
