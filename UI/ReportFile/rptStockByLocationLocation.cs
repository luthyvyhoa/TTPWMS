...
{
    public partial class rptStockByLocationLocation : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockByLocationLocation()
        {
            InitializeComponent();
        ...
        private void rptStockByLocationLocation_DataSourceDemanded(object sender, EventArgs e)
        {
        ...
        private void rptStockByLocationLocation_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
