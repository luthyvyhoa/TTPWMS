...
{
    public partial class rptPickingSlipA4ByProduct : DevExpress.XtraReports.UI.XtraReport
    {
        public rptPickingSlipA4ByProduct(bool isRandomWeight = false)
        {
            InitializeComponent();
        ...
        {
            if (string.IsNullOrEmpty(xrLabel4.Text)) return;
