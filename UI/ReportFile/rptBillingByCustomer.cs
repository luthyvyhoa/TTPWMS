...
{
    public partial class rptBillingByCustomer : DevExpress.XtraReports.UI.XtraReport
    {
        public rptBillingByCustomer(DateTime fromDate, DateTime toDate)
        {
            InitializeComponent();
        ...
        private void rptBillingByCustomer_DataSourceDemanded(object sender, EventArgs e)
        {
