...
{
    public partial class rptCombinedQuotation : DevExpress.XtraReports.UI.XtraReport
    {
        public rptCombinedQuotation()
        {
            InitializeComponent();
        ...
        private void rptCombinedQuotation_DataSourceDemanded(object sender, EventArgs e)
        {
            GroupField groupField = new GroupField("ServiceNumber");
