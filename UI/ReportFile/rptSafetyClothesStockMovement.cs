...
{
    public partial class rptSafetyClothesStockMovement : DevExpress.XtraReports.UI.XtraReport
    {
        public rptSafetyClothesStockMovement()
        {
            InitializeComponent();
        ...
        private void rptStockMovement_DataSourceDemanded(object sender, EventArgs e)
        {
