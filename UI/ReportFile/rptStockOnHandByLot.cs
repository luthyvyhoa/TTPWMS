...
{
    public partial class rptStockOnHandByLot : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockOnHandByLot()
        {
            InitializeComponent();
        ...
        private void rptStockOnHandByLot_DataSourceDemanded(object sender, EventArgs e)
        {
