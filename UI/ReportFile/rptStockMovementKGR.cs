...
{
    public partial class rptStockMovementKGR : DevExpress.XtraReports.UI.XtraReport
    {
        public rptStockMovementKGR()
        {
            InitializeComponent();
        ...
        private void rptStockMovementKGR_DataSourceDemanded(object sender, EventArgs e)
        {
