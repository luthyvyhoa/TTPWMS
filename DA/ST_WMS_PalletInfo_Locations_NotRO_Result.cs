...
namespace DA
{
    ...
    public partial class ST_WMS_PalletInfo_Locations_NotRO_Result
    {
        ...
        public Nullable<double> PalletWeight_Out { get; set; }
        public Nullable<float> SalesLifePercentage { get; set; }
