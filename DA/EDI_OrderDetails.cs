...
namespace DA
{
    ...
    public partial class EDI_OrderDetails
    {
        public EDI_OrderDetails()
        {
            this.EDI_DetailBreakdowns = new HashSet<EDI_DetailBreakdowns>();
        }
        ...
        public virtual ICollection<EDI_DetailBreakdowns> EDI_DetailBreakdowns { get; set; }
        public virtual EDI_Orders EDI_Orders { get; set; }
